...
<header class="header-v4">
    ...
    <div class="wrap-menu-desktop how-shadow1">
      <nav class="limiter-menu-desktop container">
        ...
        <a href="{{url('')}}" class="logo">
          <img src="{{url('public/upload/'.$logo->image)}}" alt="IMG-LOGO">
        </a>
          ...
          <ul class="main-menu">
              ...
              <li class="active-menu">
                  ...
                  <ul class="sub-menu">
                      ...
                      <li><a href="{{route('customer.order.list')}}">MY ORBERS</a></li>
                      <li>
  ...
  <div class="wrap-header-mobile">
    ...
    <div class="logo-mobile">
      <a href="{{url('')}}"><img src="{{url('public/upload/'.$logo->image)}}" alt="IMG-LOGO"></a>
    </div>
    ...
    <div class="header-cart-content flex-w js-pscroll">
      ...
      <ul class="header-cart-wrapitem w-full">
        ...
        <li class="header-cart-item flex-w flex-t m-b-12">
          <div class="header-cart-item-img">
            <img src="{{asset('public/upload/'.$content->options->image)}}" alt="IMG">
          </div>
      ...
      <div class="w-full">
        ...
        <div class="header-cart-buttons flex-w w-full">
          ...
          @if(@Auth::user()->id != NULL && Session::get('shipping_id') ==NULL)
          <a href="{{route('customer.checkout')}}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">Check Out </a>
          @elseif(@Auth::user()->id != NULL && Session::get('shipping_id') !=NULL)
          ...
          @else
          <a href="{{route('customer.login')}}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">Check Out </a>
          @endif
        </div>
      </div>
    </div>
