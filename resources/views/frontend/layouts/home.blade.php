  ...
  <div class="container">
    <div class="flex-w flex-sb-m p-b-52">
      <div class="flex-w flex-l-m filter-tope-group m-tb-10">
        ...
        <a href="{{route('category.wise.product',$category->category_id)}}" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5">
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
        ...
        <div class="block2">
          <div class="block2-pic hov-img0">
            <a href="{{route('product.details.info',$product->slug)}}"><img src="{{url('public/upload/'.$product->image)}}" alt="IMG-PRODUCT"></a>
