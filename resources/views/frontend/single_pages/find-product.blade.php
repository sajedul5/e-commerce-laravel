    ...
    <div class="row">
        ...
        <div class="p-l-25 p-r-30 p-lr-0-lg">
          <div class="wrap-slick3 flex-sb flex-w">
            ...
            <div class="slick3 gallery-lb">
              ...
              <div class="item-slick3" data-thumb="{{url('public/upload/'.$img->sub_image)}}">
                <div class="wrap-pic-w pos-relative">
                  <img src="{{url('public/upload/'.$img->sub_image)}}" alt="IMG-PRODUCT">

                  <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{url('public/upload/'.$img->sub_image)}}">
      ...
      <div class="col-md-6 col-lg-5 p-b-30">
        <div class="p-r-50 p-t-5 p-lr-0-lg">
          ...
          <!--  -->
          <div class="p-t-33">
            <form class="" action="{{route('insert.cart')}}" method="POST">
              @csrf
